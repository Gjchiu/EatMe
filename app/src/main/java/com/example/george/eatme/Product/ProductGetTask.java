...
class ProductGetTask extends AsyncTask<Object, Integer, List<Product>> {
    private final static String TAG = "ProductGetTask";
    private final static String ACTION = "getpro";

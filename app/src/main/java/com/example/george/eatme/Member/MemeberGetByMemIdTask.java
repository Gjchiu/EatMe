...
public class MemeberGetByMemIdTask extends AsyncTask<Object, Integer, Member> {
    private final static String TAG = "MemeberGetByMemIdTask";
    private final static String ACTION = "getMember";
